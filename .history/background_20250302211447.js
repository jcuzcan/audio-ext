...
// background.js - Using browser.runtime API for Firefox
browser.runtime.onMessage.addListener((request, sender, sendResponse) => {
  if (request.action === "getRecordingState") {
    // Simulating a response for the recording state
    let recordingState = { isRecording: true }; // Example response
    sendResponse(recordingState); // Send the response
  }
